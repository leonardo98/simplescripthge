...
public:
	...
	void posx( float &dist );
	void posy( float &dist );
	void posz( float &dist );
...
void matrix4x4f::posx( float &dist )
{
    dist = m[12];
}

void matrix4x4f::posy( float &dist )
{
    dist = m[13];
}

void matrix4x4f::posz( float &dist )
{
    dist = m[14];
}
