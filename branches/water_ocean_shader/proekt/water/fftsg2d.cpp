...
void cdft2d(int n1, int n2, int isgn, float **a, float *t, 
    int *ip, float *w)
{
...
void rdft2d(int n1, int n2, int isgn, float **a, float *t, 
    int *ip, float *w)
{
    void makewt(int nw, int *ip, float *w);
...
void ddct2d(int n1, int n2, int isgn, float **a, float *t, 
    int *ip, float *w)
{
    void makewt(int nw, int *ip, float *w);
    void makect(int nc, int *ip, float *c);
...
void ddst2d(int n1, int n2, int isgn, float **a, float *t, 
    int *ip, float *w)
{
    void makewt(int nw, int *ip, float *w);
    void makect(int nc, int *ip, float *c);
