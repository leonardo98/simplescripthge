...
//
//
void MyMovingPart::CreateQuad(HTEXTURE hTexture, const std::string &texture) {
...
//
MyMovingPart::MyMovingPart(TiXmlElement *xe, HTEXTURE hTexture)
{
	// начало блока - этот код зависит от используемого движка
...
//
void MyMovingPart::Draw(float p, MatrixStack &stack) {
