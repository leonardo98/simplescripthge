...
, _mirror(true)
{
	_pos = FPoint2D(668, 526);

	_left = Core::getAnimation("archaeopteryx_b_left");
	_leftFront = Core::getAnimation("archaeopteryx_b_leftback");
	_leftFrontIdle = Core::getAnimation("archaeopteryx_b_leftfrontidle");
	_leftBack = Core::getAnimation("archaeopteryx_b_leftback");
	...
	_region.push_back(FPoint2D(668, 526));
	_region.push_back(FPoint2D(750, 470));
	_region.push_back(FPoint2D(1000, 470));
	_region.push_back(FPoint2D(1000, 675));
	_region.push_back(FPoint2D(715, 675));
...
/*
void Archaeopteryx::Goto(FPoint2D position) {
	_endTarget = position;
}*/