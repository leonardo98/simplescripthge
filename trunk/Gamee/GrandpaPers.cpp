...
, _mirror(true)
{
	...
	_front = Core::getAnimation("grandpa_basic_front");
	_leftFront = Core::getAnimation("grandpa_basic_leftfront");
	_leftFrontIdle = Core::getAnimation("grandpa_basic_leftfront_idle");
	_left = Core::getAnimation("grandpa_basic_left");
	_back = Core::getAnimation("grandpa_basic_back");
	_leftBack = Core::getAnimation("grandpa_basic_leftback");
