...
, _mirror(true)
{
	...
	_front = Core::getAnimation("bob_basic_front");
	_leftFront = Core::getAnimation("bob_basic_leftfront");
	_leftFrontIdle = Core::getAnimation("bob_basic_leftfront_idle");
	_left = Core::getAnimation("bob_basic_left");
	_back = Core::getAnimation("bob_basic_back");
	_leftBack = Core::getAnimation("bob_basic_leftback");
